...
class AIStressTester:
    def __init__(self, base_url: str = "http://127.0.0.1:8000", frontend_url: str = "http://localhost:8080"):
...
def main():
    ...
    parser.add_argument("--frontend-url", default="http://localhost:8080", help="Frontend server URL")
    ...
    results_file = PROJECT_ROOT / "tests" / "ai_stress_test_results.json"
